...
function ClockOut({ onClockOut }: ClockOutProps) {
  return (
    <button
      type="button"
      onClick={onClockOut}
      className="flex min-h-[120px] w-full cursor-pointer items-center justify-between rounded-xs border-0 bg-secondary px-8 py-6 text-left text-secondary-foreground shadow-sm transition-transform hover:-translate-y-0.5 hover:bg-secondary/90 focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-ring"
    >
      <span>
